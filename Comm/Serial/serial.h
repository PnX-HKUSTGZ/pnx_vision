 ...
 *  @return: if retrieved at least one byte, then return true, otherwise return
 * false.
...
public:
  ...
  /**
   * @brief Try to retrive str from serial port and store in s for up to
   * milli_secs return true if at least one byte has been retrieved, otherwise
   * return false
   *
   * @param s
   * @param milli_secs
